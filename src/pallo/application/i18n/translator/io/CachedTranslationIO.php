...
class CachedTranslationIO implements TranslationIO {
     ...
     * @var pallo\library\i18n\translation\io\TranslationIO
     */
    private $io;
     ...
     * @param pallo\library\system\file\File $directory Directory for the cache
     * @return null
     */
    ...
    protected function generatePhp(array $translations) {
        $output = "<?php\n\n";
        $output .= "/*\n";
        $output .= " * This file is generated by pallo\application\i18n\CachedTranslationIO.\n";
        $output .= " */\n";
        $output .= "\n";
